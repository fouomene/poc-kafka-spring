package xyz.afrinnov.kafka.poc.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<
            ConcurrentMessageListenerContainer<String, UserDTO>> userDTOFactory(
            ConsumerFactory<String, UserDTO> userDTOConsumerFactory
    ) {
        ConcurrentKafkaListenerContainerFactory<String, UserDTO> userDTOFactory =
                new ConcurrentKafkaListenerContainerFactory<>();
        userDTOFactory.setConsumerFactory(userDTOConsumerFactory);
